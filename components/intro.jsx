      ...
      <div style={{ marginTop: "0", backgroundColor: "#BF2200" }}>
        ...
        >
          ...
          >
            ...
            <br />
            <p style={{ color: "white" }}>
              MEC has a wide network of students passionate about technology and
              learning and we nurture a system of guidance and support for those
              intending to bring their ideas into fruition. We consistently host
              technically stimulating workshops, talk sessions by accomplished
              entrepreneurs, design thinking workshops, exposure to business
              case studies, to hone the skill sets of our students as we are
              committed to the utopian dream of seeing each MECian live up to
              his/her true capabilities. We promote our startup culture by
              giving counsel and direction along with technical support and
              provide platforms to develop their entrepreneurial skills.
              <br />
              <br />
              ...
              Gopakrishnan, founder and former chairman of Infosys, etc to name
              a few from an elite legacy. Technopreneur has been a flagship
              event for MEC over the years and has lived up to the hype whenever
              it was organized garnering national attention. This year will be
        ...
        >
          <div
            ...
            style={{ color: "#BF2200", textAlign: "center" }}
          >
            {/* <img src={BGImageGlobe} className='responsive-img' style={{ marginBottom: '20px' }} alt="About us image" /> */}
            ...
            <br />
            <p style={{ color: "black" }}>
              Have an idea? Don't know how to implement it? We'll help you bring
              it to life. If you have a project or an idea in mind, we will
              provide you with the tools required to make it into a reality.
              <br />
              <br />
              IEDC MEC currently acts as a pre-incubator, we support various
              projects that our students work on, provide them financial
              assistance and help them with ideation and prototype development.
              We also provide them with mentorship and support from industry
              experts through our distinguished pool of mentors consisting of
              xMECians and accomplished entrepreneurs to scale their projects
              into sustainable and successful startup ventures.
            </p>
            <br />
          </div>
        </section>
